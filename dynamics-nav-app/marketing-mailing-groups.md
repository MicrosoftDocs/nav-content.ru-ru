...
## <a name="define-a-mailing-group-code"></a>Определение кода группы рассылки
...
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Группы рассылки**, а затем выберите связанную ссылку.
...
## <a name="assign-mailing-groups-to-a-contact"></a>Назначение групп рассылки контакту
1. Откройте контакт.
