...
3. В поле **Тип учета ОС** выберите **Повышение стоимости**.
...
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Индекс ОС**, затем выберите связанную ссылку.  
